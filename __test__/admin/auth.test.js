...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Omari_Luettgen',
      password: 'cyzKbVipqGwZ5Fe',
      email: 'Toni15@gmail.com',
      name: 'Francis Witting',
      userType: 188,
      mobileNo: '(703) 657-8395',
      resetPasswordLink: {},
      loginRetryLimit: 482,
      loginReactiveTime: '2023-07-03T05:26:31.543Z',
      ssoAuth: {
        googleId: 'Visionary',
        facebookId: 'Arizona' 
      },
      id: '63da64cc40d84c9d2f8118a2'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Eriberto70',
        'password':'_2hPlWUl8z2EQAI',
        'email':'Clarabelle.Green@gmail.com',
        'name':'Kelli Price',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(982) 349-7319',
        'ssoAuth':{
          'googleId':'withdrawal',
          'facebookId':'customized'
        },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Clarabelle.Green@gmail.com', });
