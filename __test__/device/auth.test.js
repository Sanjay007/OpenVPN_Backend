...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Douglas.Hettinger22',
      password: 'CvqKjVpWbadLZXL',
      email: 'Conner.Hessel@yahoo.com',
      name: 'Mr. Cassandra Beatty',
      userType: 174,
      mobileNo: '(473) 418-3175',
      resetPasswordLink: {},
      loginRetryLimit: 795,
      loginReactiveTime: '2023-05-09T18:49:15.072Z',
      ssoAuth: {
        googleId: 'online',
        facebookId: 'ability' 
      },
      id: '63da64cc40d84c9d2f8118cc'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Shemar.Stamm',
        'password':'UIfC1jTORmIp7Cm',
        'email':'Lisandro.Gerlach40@yahoo.com',
        'name':'Sara Runte',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(644) 989-8536',
        'ssoAuth':{
          'googleId':'payment',
          'facebookId':'Bedfordshire'
        },
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Lisandro.Gerlach40@yahoo.com', });
