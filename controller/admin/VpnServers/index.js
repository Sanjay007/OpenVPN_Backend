...
const bulkInsertVpnServersUsecase = require('../../../use-case/VpnServers/bulkInsertVpnServers')({ VpnServersDb });
...
const bulkUpdateVpnServersUsecase = require('../../../use-case/VpnServers/bulkUpdateVpnServers')({ VpnServersDb });
...
const bulkInsertVpnServers = VpnServersController.bulkInsertVpnServers(bulkInsertVpnServersUsecase);
...
const bulkUpdateVpnServers = VpnServersController.bulkUpdateVpnServers(bulkUpdateVpnServersUsecase);
...
module.exports = {
  addVpnServers,
  bulkInsertVpnServers,
  findAllVpnServers,
  getVpnServersCount,
  getVpnServersById,
  updateVpnServers,
  partialUpdateVpnServers,
  bulkUpdateVpnServers,
