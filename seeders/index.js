...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'o0sf9S_XVAMxCdJ',
      'isDeleted':false,
      'username':'Jerald86',
      'email':'Casimir76@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Jerald86' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'VsN_rsK5YLcK85m',
      'isDeleted':false,
      'username':'Kelly_Rippin76',
      'email':'Madison_Gislason@hotmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Kelly_Rippin76' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/vpnservers/addbulk',
        role: 'Admin',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/admin/vpnservers/update/:id',
        role: 'Admin',
        method: 'PUT' 
      },
      {
      ...
      {
        route: '/admin/vpnservers/partial-update/:id',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/admin/vpnservers/updatebulk',
        role: 'Admin',
        method: 'PUT' 
      },
      {
      ...
      {
        route: '/admin/vpnservers/softdelete/:id',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/admin/vpnservers/softdeletemany',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/admin/vpnservers/delete/:id',
        role: 'Admin',
        method: 'DELETE'
      },
      {
      ...
      {
        route: '/admin/vpnservers/deletemany',
        role: 'Admin',
        method: 'POST'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/create',
        role: 'Admin',
        method: 'POST'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/addbulk',
        role: 'Admin',
        method: 'POST'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/list',
        role: 'Admin',
        method: 'POST'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/:id',
        role: 'Admin',
        method: 'GET'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/count',
        role: 'Admin',
        method: 'POST'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/update/:id',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/partial-update/:id',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/updatebulk',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/softdelete/:id',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/softdeletemany',
        role: 'Admin',
        method: 'PUT'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/delete/:id',
        role: 'Admin',
        method: 'DELETE'
      },
      {
      ...
      {
        route: '/device/api/v1/vpnservers/deletemany',
        role: 'Admin',
        method: 'POST'
      },
      {
